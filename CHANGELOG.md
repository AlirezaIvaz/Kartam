...
- **جدید:** پشتیبانی از نئوبانک زیپاد
- **جدید:** امکان ثبت نام کاربری و گذرواژه اپلیکیشن بانک کارت‌های شخصی
- **جدید:** گزینهٔ جلوگیری از اسکرین‌شات گرفتن (آزمایشی)
- **جدید:** تشخیص خودکار شمارهٔ کارت از کلیپ‌بورد (آزمایشی)
- **جدید:** کپی با تک‌ضرب و اشتراک‌گذاری با نگه‌داشتن انگشت در جزئیات کارت
- **جدید:** قفل‌شدن خودکار برنامه هنگام بازگشت از پس‌زمینه
- **حل‌شد:** برخی مشکلات جزئی
- **حل‌شد:** دکمه‌های کپی و اشتراک‌گذاری سریع برگشتند
- **حل‌شد:** اعتبارسنجی زیستی پیش‌از غیرفعال‌کردن قفل برنامه و گزینه‌های امنیتی
- **بهبود یافته:** حجم برنامه
- **بهبود یافته:** رابط کاربری برنامه
- **بهبود یافته:** کارکرد برنامه

## ۱٫۷٫۰ (۲۰ فروردین ۱۴۰۵)

- **جدید:** پشتیبانی از گرین‌بانک
- **جدید:** پنجرهٔ اشتراک‌گذاری قابل شخصی‌سازی
- **جدید:** اجازه به استفاده از شمارهٔ کارت نادرست با تایید کاربر
- **حل‌شد:** برخی مشکلات جزئی
- **بهبود یافته:** رابط کاربری برنامه
- **بهبود یافته:** کارکرد برنامه
...
- **حل‌شد:** مشکلات پشتیبان‌گیری و بازیابی
- **حل‌شد:** برخی مشکلات جزئی

## ۱٫۶٫۰ (۲۳ بهمن ۱۴۰۴)

- **جدید:** پشتیبان‌گیری و بازیابی دستی
- **حل‌شد:** برخی مشکلات جزئی
- **بهبود یافته:** کارکرد برنامه
