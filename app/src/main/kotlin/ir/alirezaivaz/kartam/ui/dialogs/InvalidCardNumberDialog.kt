    ...
    AlertDialog(
        icon = {
            Icon(
                ...
                contentDescription = stringResource(R.string.invalid_card_number_title)
            )
        },
        title = {
            Text(text = stringResource(R.string.invalid_card_number_title))
        },
        text = {
            Text(text = stringResource(R.string.invalid_card_number_message))
        },
        onDismissRequest = {},
        confirmButton = {
            TextButton(
