...
class PersianDatePickerController {
    ...
    private var _minYear: MutableState<Int> = mutableIntStateOf(getPersianYear())
    ...
    private var _displayMonthNames: MutableState<Boolean> = mutableStateOf(false)
    internal val displayMonthNames get() = _displayMonthNames.value

    private var _displayPersianDigits: MutableState<Boolean> = mutableStateOf(false)
    internal val displayPersianDigits get() = _displayPersianDigits.value
    ...
    fun updateDisplayPersianDigits(value: Boolean) {
        _displayPersianDigits.value = value
    }
